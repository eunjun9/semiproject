...
public class MagazineDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	Magazine magazine = MagazineService.selectMagazine(userId);
...
//		System.out.println(board);
		...
		if(magazine != null) {
			...
			request.getRequestDispatcher("/WEB-INF/views/magazine/magazineDetailView.jsp").forward(request, response);
		} else {
