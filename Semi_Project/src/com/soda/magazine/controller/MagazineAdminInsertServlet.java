...
public class MagazineAdminInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MagazineAdminInsertServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 request.getRequestDispatcher("/WEB-INF/views/magazine/magazineAdminInsert.jsp").forward(request, response);
	   }
...
//	      System.out.println(photoList);
	      ...
	      int result = new MagazineService().insertAdmin(admin);
