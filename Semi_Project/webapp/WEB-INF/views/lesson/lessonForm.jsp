    ...
    <div class="class_form">
        ...
        <div id="cForm_wrapper">
            <form method="post">
                ...
                <input type="text" name="cPrice" placeholder="'원' 빼고 입력">원
                <hr>
                ...
                <div id="form_head">
                    <textarea id="sub_title6" placeholder="클래스 제목을 입력하세요(최대25자)"></textarea>
                    <hr>
                ...
                <hr>  
                <h4>강사 소개를 작성하세요</h4>
                <textarea name="tutor_intro" id="tutor_intro"></textarea>
                
                <h4>날짜를 선택하세요</h4>
                <input type="date" name="class_date1"> &nbsp;부터 &nbsp;<input type="date" name="class_date2"> &nbsp;까지
