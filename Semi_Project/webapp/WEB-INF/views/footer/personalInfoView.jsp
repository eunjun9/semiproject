    ...
    <div class="page body">
        <div class="titleArea">
            <div class="titleArea2">
                <h2 id="title">개인정보 취급 방침</h2>
            </div>
        </div>
        <div class="body-inner">
            <p>
                소다는 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.<br>
            ...
            <p>
                ...
                ο 수집항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 자택 주소 , 휴대전화번호 , 이메일 , 직업 , 회사명 , 부서 , 직책 , 회사전화번호 , 취미 , 결혼여부 , 기념일 , 법정대리인정보 , 주민등록번호 , 서비스 이용기록 , 접속 로그 , 접속 IP 정보 , 결제기록<br>
            ...
            <p>
                <b>■ 이용자 및 법정대리인의 권리와 그 행사방법</b><br>
            ...
            <p>
                <b>■ 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항</b><br>
